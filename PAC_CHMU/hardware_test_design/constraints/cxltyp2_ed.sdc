...
set emif_usr_clk_0 [get_clocks ed_top_wrapper_typ2_inst|MC_CHANNEL_INST[0].mc_top|GEN_CHAN_COUNT_EMIF[0].NON_HPS_MEM.emif_inst|emif_core_usr_clk]
set emif_usr_clk_1 [get_clocks ed_top_wrapper_typ2_inst|MC_CHANNEL_INST[0].mc_top|GEN_CHAN_COUNT_EMIF[1].HPS_MEM.emif_inst_2|emif_fm_0_core_usr_clk]
