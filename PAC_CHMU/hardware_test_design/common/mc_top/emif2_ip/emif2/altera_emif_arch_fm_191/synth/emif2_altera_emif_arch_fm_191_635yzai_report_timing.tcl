...
if { ! [timing_netlist_exist] } {
   ...
   source "$script_dir/emif2_altera_emif_arch_fm_191_635yzai_report_timing_core.tcl"
   if { ! [timing_netlist_exist] } {
...
emif2_altera_emif_arch_fm_191_635yzai_initialize_ddr_db ddr_db var
...
foreach inst $instances {
   ...
   if {[llength $instances] <= 1} {
      set fbasename "${::GLOBAL_emif2_altera_emif_arch_fm_191_635yzai_corename}"
   } else {
      set fbasename "${::GLOBAL_emif2_altera_emif_arch_fm_191_635yzai_corename}_${inst_id}"
   }
   ...
   emif2_altera_emif_arch_fm_191_635yzai_perform_core_analysis $opcname $inst pins var summary


   set summary [lsort -command emif2_altera_emif_arch_fm_191_635yzai_sort_proc $summary]

   post_message -type info "Core: ${::GLOBAL_emif2_altera_emif_arch_fm_191_635yzai_corename} - Instance: $inst"
   ...
   foreach summary_line $summary {
      ...
      if {$su != "--"} {
         set su [ emif2_altera_emif_arch_fm_191_635yzai_round_3dp $su]
      }
      if {$hold != "--"} {
         set hold [ emif2_altera_emif_arch_fm_191_635yzai_round_3dp $hold]
      }
